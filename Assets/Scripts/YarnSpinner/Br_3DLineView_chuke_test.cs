...
namespace Yarn.Unity
{
    ...
    /// elements.
    /// </summary>
    public class Br_3DLineView_chuke_test : DialogueViewBase
    {
            ...
            IEnumerator PresentLine()
            {
                ...
                else
                {
                    ...
                    if (showCharacterNameInLineView)
                    {
                        ...
                        lineText.text = "\n" + "<uppercase><style=" + characterName + ">" + characterName + "</uppercase><indent=7.25em>" + dialogueLine.TextWithoutCharacterName.Text + "</indent></style>";
                        if(characterNameStored != null && characterName == characterNameStored)
                        {
                            _text.text += "\n" + "<uppercase><style=" + characterName + ">" + "</uppercase><indent=7.25em>" + dialogueLine.TextWithoutCharacterName.Text + "</indent></style>";
                        }
                        else
                        {
                            _text.text += "\n\n" + "<uppercase><style=" + characterName + ">" + characterName + "</uppercase><indent=7.25em>" + dialogueLine.TextWithoutCharacterName.Text + "</indent></style>";
                            characterNameStored = characterName;
                        }
                        /***
                        ...
                        {
                            lineText.text = "\n" + "<uppercase><style=" + dialogueLine.CharacterName + ">" + "</uppercase><indent=7.25em>" + dialogueLine.TextWithoutCharacterName.Text + "</indent></style>";
                            _text.text += lineText.text;
                            yield break;
                        }
                        else
